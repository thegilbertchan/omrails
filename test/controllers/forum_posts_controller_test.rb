...
class ForumPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_post" do
    assert_difference('ForumPost.count') do
      post forum_posts_url, params: { forum_post: { content: @forum_post.content, forum_thread_id: @forum_post.forum_thread_id, user_id: @forum_post.user_id } }
    end
  ...
  test "should update forum_post" do
    patch forum_post_url(@forum_post), params: { forum_post: { content: @forum_post.content, forum_thread_id: @forum_post.forum_thread_id, user_id: @forum_post.user_id } }
